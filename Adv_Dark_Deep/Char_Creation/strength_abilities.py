...
str_1801_1850 = Strength(1, 3, 100, 0.5, 0, 20)
...
str_1800 = Strength(3, 6, 300, 0.83, 0.33, 40)
...
str_abilities = (None, str_1, str_2, str_3, str_4, str_5, str_6, str_7, str_8, str_9, str_10, str_11, str_12, str_13,
                 str_14, str_15, str_16, str_17, str_18, str_1801_1850, str_1851_1875, str_1876_1890, str_1891_1899,
                 str_1800, str_19, str_20, str_21, str_22, str_23, str_24, str_25)


def get_str_ability(str_val, ability):
    """Get the appropriate ability for a given strength value"""
    if 1801 < str_val < 1851:
        ability_val = str_1801_1850[ability]
    elif 1851 < str_val < 1876:
        ability_val = str_1876_1890[ability]
    elif 1876 < str_val < 1891:
        ability_val = str_1876_1890[ability]
