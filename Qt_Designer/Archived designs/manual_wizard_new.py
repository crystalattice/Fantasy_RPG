...
class Page1(QWizardPage):
    def __init__(self, parent=None):
        ...
        # self.horizontalLayout.addWidget(self.Gender_groupBox)
        self.Gender_groupBox = QtWidgets.QGroupBox(self)
        ...
        # self.frame.setGeometry(QtCore.QRect(9, 120, 511, 171))
        # #
        ...
        self.Four_dice_radioButton.setChecked(True)
        self.Four_dice_radioButton.setObjectName("Four_dice_radioButton")
        self.Dice_Type_buttonGroup = QtWidgets.QButtonGroup(self)
        self.Dice_Type_buttonGroup.setObjectName("Dice_Type_buttonGroup")
        self.Dice_Type_buttonGroup.addButton(self.Four_dice_radioButton)
        ...
        self.Rolling_Options_label.setText(_translate("Wizard",
        ...
        self.label.setText(_translate("Wizard",
                                      "Gender and attributes affect the possible races you can choose for your character (next page)."))
